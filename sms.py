...
class SendSms():
    ...
    def Dolap(self):
        try:
            ...
            json={"advertisingId": "", "campaignAgreement": False, "email": self.mail, "memberCookie": "", "membershipAgreement": True, "nickName": "Wiper", "password": "31ABC..abc31", "phoneNumber": self.phone}
